...
export default function KidsHomePage() {
    ...
    const [stats, setStats] = useState({ xp: 250, streak: 5, badges: 3 });
    ...
    return (
        <div className="page-content">
            ...
            <div className="bg-white rounded-2xl p-6 shadow-lg mb-6">
                ...
                <div className="space-y-3">
                    <div className="bg-gradient-to-r from-purple-100 to-pink-100 rounded-xl p-4">
                        <h3 className="font-semibold text-gray-800">Spot the Phishing Link</h3>
                        <p className="text-sm text-gray-600 mt-1">Lesson 3 • 5 min</p>
            ...
            <div className="bg-white rounded-2xl p-6 shadow-lg">
                ...
                {loading ? (
                    ...
                    <div className="text-center py-8">
                        ...
                        <p className="text-sm text-gray-400 mt-2">Complete lessons to earn your first badge 🎯</p>
                    </div>
                ) : (
                    <div className="space-y-3">
            ...
            {/* Ask Asterix Button */}
            <button
                onClick={() => router.push('/kids/assistant')}
                className="w-full mt-6 bg-teal-500 hover:bg-teal-600 text-white rounded-full py-3 px-5 shadow-[0_4px_0_0_rgba(6,182,212,0.4)] hover:shadow-[0_3px_0_0_rgba(6,182,212,0.4)] active:shadow-[0_1px_0_0_rgba(6,182,212,0.4)] hover:translate-y-0.5 active:translate-y-1 transition-all duration-150 flex items-center justify-center gap-3"
            >
